  ...
  return (
    <div className="mx-auto grid min-h-[60vh] max-w-container place-items-center px-5 sm:px-8 lg:px-12">
      <div className="text-center">
        ...
        <Link
          href="/"
          className="mt-8 inline-block rounded-full bg-primary px-6 py-2.5 font-medium text-primary-foreground transition-opacity hover:opacity-90 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
        >
          {t('backHome')}
        </Link>
      </div>
